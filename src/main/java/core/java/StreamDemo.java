...
public class StreamDemo {
    ...
    public static void main(String[] args) {
        ...
        myList.stream().filter(x -> x==35).findFirst().ifPresent(System.out::println);
        ...
        System.out.println( "Second Last" +   myList.stream().sorted(Collections.reverseOrder()).skip(1).findFirst());

        System.out.println( "Second Last" +   myList.stream().sorted().skip(myList.size()-2).findFirst());
